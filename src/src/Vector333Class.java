...
public class Vector333Class {
     ...
     */
    public Vector333Class(int x, int y) {
        this.x = 0;
        this.y = 0;
    }
     ...
     */
    public Vector333Class(long x, long y) {
        this.x = 0;
        this.y = 0;
    }
     ...
     */
    public Vector333Class(double x, double y) {
        this.x = 0;
        this.y = 0;
    }
     ...
     */
    public boolean equals(Vector333Class v) {
        //get differences
     ...
     */
    public Vector333Class add(Vector333Class v) {
        //add vectors
        Vector333Class summedVector = new Vector333Class();
     ...
     */
    public Vector333Class subtract(Vector333Class v) {
        //subtract vectors
        Vector333Class subtractedVector = new Vector333Class();
     ...
     */
    public double dotProduct(Vector333Class v) {
     ...
     */
    public Vector333Class scale(double s) {
        //scale vector
        Vector333Class scaledVector = new Vector333Class();
     ...
     */
    public Vector333Class normalize() {
        Vector333Class normalizedVector = new Vector333Class();
     ...
     * @throws java.lang.Exception - object with the message set to a description of the parsing error encountered
     */
    public static Vector333Class parseVector(java.util.Scanner s) throws Exception {
        try {
            //create the return vector
            Vector333Class newVector = new Vector333Class();
            //split string vector
